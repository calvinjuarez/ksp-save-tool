...
The PWA web manifest is generated at build time from [`src/app/app.const.js`](../../src/app/app.const.js) (see [ADR-002](002-centralized-app-meta.md)); `vite-plugin-pwa` registers the service worker and generates the precache list.
